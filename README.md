bitcoind docker build for x86_64 hardware.

warning the docker image size is huge. sorry.

bitcoind build credit Peter Todd's libre-relay. (https://github.com/petertodd/bitcoin/tree/libre-relay-v28.0)

docker-bitcoind credit Kyle Manna. (https://github.com/kylemanna/docker-bitcoind)
